...
export function AttendanceSummaryCards({ sectionId, date }: AttendanceSummaryCardsProps) {
  ...
  const cards = [
    ...
    },
    {
      ...
      percent: summary.total ? Math.round((summary.present / summary.total) * 100) : 0,
    },
    {
      title: 'Absent',
      ...
      percent: summary.total ? Math.round((summary.absent / summary.total) * 100) : 0,
    },
    {
      title: 'Late / Leave',
      value: summary.lateLeave,
      icon: Clock,
      color: 'text-yellow-600',
      bg: 'bg-yellow-100 dark:bg-yellow-900/30',
      percent: summary.total ? Math.round((summary.lateLeave / summary.total) * 100) : 0,
    },
  ]
    ...
    <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
      {cards.map((card, idx) => {
        ...
        return (
          <div
            key={idx}
            className="erp-card flex items-center justify-between p-4 bg-white dark:bg-gray-900 rounded-xl border border-gray-100 dark:border-gray-800 shadow-sm"
          >
            <div>
